...
BOARD_SUPER_PARTITION_GROUPS := mithorium_dynpart
BOARD_MITHORIUM_DYNPART_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SIZE) - 4194304)
BOARD_MITHORIUM_DYNPART_PARTITION_LIST := $(ALL_PARTITIONS)
